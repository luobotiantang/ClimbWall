...
[Chrome一键翻墙包 Mac版下载](#chromego-xia-zai-di-zhi))
...
1. 首先设置 [MAC允许未知来源的应用](https://github.com/luobotiantang/ClimbWall/blob/main/MAC允许未知来源的应用.md), 然后从上面的下载链接下载, 比如下载到了下载文件夹
